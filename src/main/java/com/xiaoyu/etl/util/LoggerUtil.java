...
import com.xiaoyu.etl.util.IPSeekerExt.RegionInfo;
import com.xiaoyu.etl.util.UserAgentUtil.UserAgentInfo;
...
public class LoggerUtil {
    ...
    public static Map<String, String> handleLog(String logText) {
        ...
        if (StringUtils.isNotBlank(logText)) {
            ...
            if (splits.length == 4) {// ip,time,servername,request
